...
function recupererCargaisonsDepuisTableau() {
    const cargaisons = [];
...
function filtrerCargaisons(cargaisons, texteRecherche) {
...
function addCargaison() {
    ...
    ajoutProduitsButton.onclick = () => {
        const modal = document.getElementById("modalAjoutProduits");
        modal.showModal();
    };
...
document.addEventListener('DOMContentLoaded', () => {
    const champRecherche = document.querySelector('.search .inputSearch input');
